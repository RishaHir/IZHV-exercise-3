...
public class Gun : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        if (mFiring && fireEnabled)
        {
            ...
            if (shotgun)
            {
                secondsPerBullet *= shotgunBullets / 1.25f;
            }
    ...
    public void ShootGun(Transform director)
    {
        ...
        if (shotgun)
        {
            ...
            {
                SpawnBullet(director.position + (director.rotation * Quaternion.Euler(0, 0,  shotgunSpread / 2  - shotgunSpread / (shotgunBullets - 1) * i) * Vector3.up) * spawnOffset, director.rotation * Quaternion.Euler(0, 0,  shotgunSpread / 2  - shotgunSpread / (shotgunBullets - 1) * i));
            }
        }
        else
        {
    ...
    public void SpawnBullet(Transform director)
    {
        ...
        bulletPosition += (bulletRotation * Vector3.up) * spawnOffset;
